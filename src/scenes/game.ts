...
import { cartToIso } from '../utils/math'

export default class GameScene extends Phaser.Scene {
  public static readonly SCENE_KEY = 'game-scene'
  private readonly TILE_SIZE = 64
  private readonly TILE_ISO_WIDTH = 128
  private readonly TILE_ISO_HEIGHT = 64
  private readonly TILE_ISO_VISUAL_HEIGHT = 96

  private dirs: IDirection[] = [
  ...
  private userPath: IDirection[] = []
  private arrows: Phaser.GameObjects.Group
  private pathArrows: Phaser.GameObjects.Group
